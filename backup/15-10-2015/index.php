    ...
    <head>
        ...
        <!-- //ends -->
            ...
            $(function(){
                ...
                sortImage();
                function sortImage(){
                    var r = ['<img id="satu" class="img-play-pizza" src="./images/img-play-pizza1.jpg">','<img  class="img-play-pizza" src="./images/img-play-pizza2.jpg">','<img class="img-play-pizza" src="./images/img-play-pizza3.jpg">','<img class="img-play-pizza" src="./images/img-play-pizza4.jpg">'];
                    shuffle(r);
                    console.log(r);
                    $(".box_1").html(r[0]);
                    $(".box_2").html(r[1]);
